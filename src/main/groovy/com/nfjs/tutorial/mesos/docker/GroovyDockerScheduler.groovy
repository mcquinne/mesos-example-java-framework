 ...
 */
public class GroovyDockerScheduler implements Scheduler {

  /**
   * Logger.
   */
  private static final Logger logger = LoggerFactory.getLogger(JavaDockerScheduler.class)
   ...
   * Constructor.
   */
  public JavaDockerScheduler(String imageName, int desiredInstances) {
